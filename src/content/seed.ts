...
export const caseDocs: any[] = [
  ...
  {
    _id: 'la-direccion-a-ciegas',
    slug: 'la-direccion-a-ciegas',
    index: '03',
    title: 'Del cierre a tres semanas al dato del día',
    sector: 'Distribución B2B · 40 personas',
    summary:
      'Dirección decidía con datos de hace semanas. Automatizamos la información y hoy ven el negocio en tiempo real.',
    challenge:
      'El cierre contable se reconstruía a mano y llegaba tres semanas tarde. La información estaba repartida entre departamentos y cada uno tenía su versión. Las decisiones se tomaban sobre el pasado, y los problemas se veían cuando ya habían costado dinero.',
    intervention: [
      'Unificamos los datos dispersos en una sola fuente',
      'Automatizamos la captura y la conciliación de información',
      'Montamos un panel de control para dirección',
      'Configuramos alertas ante desviaciones',
      'Formamos a los responsables de cada área',
    ],
    result: [
      'El cierre pasó de tres semanas a pocos días',
      'Una única versión de la realidad para todo el comité',
      'Alertas antes de que el problema cueste dinero',
      'Dirección pasa de reaccionar a anticipar',
    ],
  },
]
  ...
  footerColumns: [
    {
      ...
      links: [
        ...
        {label: 'La dirección a ciegas', href: '/casos/la-direccion-a-ciegas'},
      ],
    },
    {
      title: 'Intervención',
